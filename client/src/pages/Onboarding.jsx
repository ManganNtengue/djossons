            ...
            <div className="onboarding">
                ...
                <form onSubmit={handleSubmit}>
                    <section>
                        ...
                        <label htmlFor="show-gender">Afficher mon genre sur mon profile</label>
                        ...
                        <div className="multiple-input-container">
                            ...
                            />
                            <label htmlFor="everyone-gender-interest">Tout le monde</label>
                        ...
                        <input
                            ...
                            name="about"
                            required={true}
                            placeholder="J'aime les balades..."
                    ...
                    <section>
                        ...
                        <label htmlFor="url">Photo de Profile</label>
                        <input
                            type="url"
                            name="url"
                            id="url"
